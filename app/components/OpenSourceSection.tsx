  ...
  return (
    <section className="relative overflow-hidden bg-black py-24 px-4">
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        <span className="inline-block rounded-full border border-zinc-700 bg-black/80 px-4 py-1 text-xs font-bold mb-8 font-mono text-zinc-400 uppercase tracking-widest">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
          <div className="relative flex flex-col items-center bg-zinc-900/70 border border-zinc-700 rounded-xl p-6 transition-all hover:shadow-lg hover:border-zinc-400">
          ...
          <div className="relative flex flex-col items-center bg-zinc-900/70 border border-zinc-700 rounded-xl p-6 transition-all hover:shadow-lg hover:border-zinc-400">
            <div className="absolute inset-0 pointer-events-none rounded-xl bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size-[24px_24px]" />
            <SiOutline className="relative z-10 text-4xl mb-2 text-purple-400 transition-all hover:text-white hover:drop-shadow-glow" />
            <h3 className="relative z-10 font-semibold text-lg mb-2 text-white">
              Outline
            </h3>
            <p className="relative z-10 text-sm leading-relaxed text-zinc-500 font-mono">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="relative flex flex-col items-center bg-zinc-900/70 border border-zinc-700 rounded-xl p-6 transition-all hover:shadow-lg hover:border-zinc-400">
            <div className="absolute inset-0 pointer-events-none rounded-xl bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size-[24px_24px]" />
            <FaGithub className="relative z-10 text-3xl mb-2 text-white transition-all hover:text-blue-400 hover:drop-shadow-glow" />
            <h3 className="relative z-10 font-semibold text-lg mb-2 text-white">
          ...
          <div className="relative flex flex-col items-center bg-zinc-900/70 border border-zinc-700 rounded-xl p-6 transition-all hover:shadow-lg hover:border-zinc-400">
            <div className="absolute inset-0 pointer-events-none rounded-xl bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size-[24px_24px]" />
            <FaCheckCircle className="relative z-10 text-3xl mb-2 text-blue-400 transition-all hover:text-white hover:drop-shadow-glow" />
            <h3 className="relative z-10 font-semibold text-lg mb-2 text-white">
              OSS Support
            </h3>
            <p className="relative z-10 text-sm leading-relaxed text-zinc-500 font-mono">
